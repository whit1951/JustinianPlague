...
calc_duration<-function(out){
 ...
 return(c(ifelse(length(which(difference>100)[length(which(difference>100))])>0, which(difference>100)[length(which(difference>100))], 0), max(difference)))
}
...
write.csv(comp, "NumberDead2019_09_03.csv")
...
tiff("Fig1.tiff", width=7, height=5, units="in", compression = "lzw", res=1200)
...
calc_duration<-function(out){
 ...
 return(ifelse(length(which(difference>100)[length(which(difference>100))])>0, which(difference>100)[length(which(difference>100))], 0) )
}
...
tiff("FigS1.tiff", width=7, height=5, units="in", compression = "lzw", res=1200)
...
tiff("FigS2.tiff", width=7, height=5, units="in", compression = "lzw", res=1200)
