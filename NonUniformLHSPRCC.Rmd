---
title: "Non Uniform Sensitivity Analysis"
author: "Lauren White"
date: "9/1/2019"
...
niter<-1000 #number of times to bootstrap CI for PRCC
...
tiff("FigureS4PneumonicSIR_PRCC.tiff", height =8.7 , width =10, units = "cm", compression = "lzw", res = 1200)
multiplot(A, B, cols=2)
dev.off()
```
...
tiff("FigureS5PneumonicSEIR_PRCC.tiff", height =8.7 , width =10, units = "cm", compression = "lzw", res = 1200)
multiplot(A, B, cols=2)
dev.off()
```
...
tiff("FigureS6BubonicSIR_PRCC.tiff", height =8.7 , width =10, units = "cm", compression = "lzw", res = 1200)
multiplot(A, B, cols=2)
dev.off()
```
...
tiff("FigureS7BubonicSEIR_PRCC.tiff", height =8.7 , width =10, units = "cm", compression = "lzw", res = 1200)
multiplot(A, B, cols=2)
dev.off()
```
...
tiff("FigureS8BubonicSIRrK_PRCC.tiff", height =8.7 , width =10, units = "cm", compression = "lzw", res = 1200)
multiplot(A, B, cols=2)
dev.off()
...
tiff("FigureS9BubonicSEIRrK_PRCC.tiff", height =8.7 , width =10, units = "cm", compression = "lzw", res = 1200)
multiplot(A, B, cols=2)
dev.off()
...
tiff("FigureS10bpSEIR_PRCC.tiff", height =8.7 , width =10, units = "cm", compression = "lzw", res = 1200)
multiplot(A, B, cols=2)
dev.off()
```
...
tiff("Figure2ModelComparison.tiff", height =28 , width =20, units = "cm", compression = "lzw", res = 1200)
multiplot(A, B, C, cols=1)
dev.off()
