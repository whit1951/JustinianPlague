...
tiff("FigS4.tiff", height =22.23 , width =19.05, units = "cm", compression = "lzw", res = 600)
...
tiff("FigS5.tiff", height =22.23 , width =19.05, units = "cm", compression = "lzw", res = 1200)
multiplot(A, B, C, D, cols=2)
dev.off()
```
...
tiff("FigS6.tiff", height =22.23 , width =19.05, units = "cm", compression = "lzw", res = 600)
multiplot(A, B, C, D, cols=2)
dev.off()
...
tiff("FigS7.tiff", height =10 , width =19.05, units = "cm", compression = "lzw", res = 600)
multiplot(A, B, cols=2)
dev.off()
```
